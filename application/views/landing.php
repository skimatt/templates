        ...
        <div class="container">
          ...
          <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-4">
                <img src="img/front-pages/icons/laptop.png" alt="laptop charging" />
              </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-4">
                <img src="img/front-pages/icons/rocket.png" alt="transition up" />
              </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-4">
                <img src="img/front-pages/icons/check.png" alt="3d select solid" />
              </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-4">
                <img src="img/front-pages/icons/keyboard.png" alt="google docs" />
              </div>
          ...
          <div class="row g-6 pt-lg-5">
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="card border border-primary shadow-xl">
                <div class="card-header">
                  <div class="text-center">
                    <img src="img/front-pages/icons/plane.png" alt="plane icon" class="mb-8 pb-2" />
          ...
          <div class="row gy-6">
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-primary shadow-none">
                <div class="card-body text-center">
                  <img src="img/front-pages/icons/laptop.png" alt="laptop" class="mb-4" />
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-success shadow-none">
                <div class="card-body text-center">
                  <img src="img/front-pages/icons/user-success.png" alt="laptop" class="mb-4" />
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-info shadow-none">
                <div class="card-body text-center">
                  <img src="img/front-pages/icons/diamond-info.png" alt="laptop" class="mb-4" />
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-warning shadow-none">
                <div class="card-body text-center">
                  <img src="img/front-pages/icons/check-warning.png" alt="laptop" class="mb-4" />
